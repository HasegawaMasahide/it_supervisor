 ...
 * 使用方法:
 *   cd tools
 *   npx tsx scripts/run-audit-laravel.ts
 */
...
async function main() {
  ...
  if (laravelFw && laravelFw.version && /^[4-7]\./.test(laravelFw.version)) {
    recommendations.push({
      priority: 'critical',
